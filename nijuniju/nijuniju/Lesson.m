...
-(NSArray*)russianLesson
{
	...
	return @[
	  ...
	  @[@"своё", @"one'sown,my,our"],
	  @[@"какой", @"what,which,how"],
	  @[@"когда", @"when,while,as"],
	  @[@"уже", @"already,bynow"],
	  @[@"для", @"for,to"],
	  @[@"вот", @"here,there,thisis,that's"],
	  @[@"кто", @"who,that,some"],
	  @[@"да", @"yes,but"],
	  ...
	  @[@"ни", @"nota,not,neither…nor"],
	  @[@"стать", @"tobecome,begin,come"],
	  ...
	  @[@"хотеть", @"towant,like"],
	  @[@"ли", @"whether,if"],
	  @[@"при", @"attachedto,inthepresenceof,by,about;masterrussian,dotcom"],
	  ...
	  @[@"тогда", @"then"],
	  @[@"ведь", @"yousee,youknow"],
	  @[@"хороший", @"good,nice(see#)"],
	  @[@"каждый", @"each,every"],
	  @[@"новый", @"new;modern"],
	  @[@"жить", @"tolive"],
	  @[@"должный", @"due,proper"],
	  @[@"смотреть", @"tolook,watch"],
	  @[@"почему", @"why"],
	  @[@"потому", @"that'swhy"],
	  @[@"сторона", @"side,party"],
	  @[@"просто", @"simply"],
	  ...
	  @[@"дверь", @"door"],
	  @[@"перед", @"before,infrontof"],
	  @[@"нужный", @"necessary"],
	  @[@"понимать", @"tounderstand"],
	  @[@"казаться", @"toseem,appear;masterrussian,dotcom"],
	  @[@"работа", @"work,job"],
	  @[@"три", @"three"],
	  @[@"ваш", @"yours"],
	  @[@"уж", @"really,already"],
	  ...
	  @[@"голос", @"voice"],
	  @[@"город", @"town,city"],
	  @[@"последний", @"last,thelatest,new"],
	  @[@"пока", @"forthepresent"],
	  @[@"хорошо", @"well(see#)"],
	  @[@"давать", @"togive;let,allow"],
	  @[@"вода", @"water"],
	  @[@"более", @"more"],
	  @[@"хотя", @"although"],
	  @[@"всегда", @"always"],
	  @[@"второй", @"second"],
	  @[@"куда", @"where,whatfor,much"],
	  @[@"пойти", @"togo"],
	  ...
	  @[@"остаться", @"toremain,stay(see#)"],
	  @[@"об", @"about,of(see#)"],
	  @[@"вид", @"appearance,look,view"],
	  @[@"выйти", @"togoout,comeout,appear"],
	  @[@"дать", @"togive;masterrussian,dotcom"],
	  @[@"работать", @"towork"],
	  @[@"любить", @"tolove"],
	  @[@"старый", @"old"],
	  @[@"почти", @"almost"],
	  @[@"ряд", @"row,line"],
	  @[@"оказаться", @"findoneself,turnout"],
	  ...
	  @[@"война", @"war"],
	  @[@"снова", @"again"],
	  @[@"ответить", @"toanswer,reply(see#)"],
	  @[@"между", @"between,among"],
	  @[@"подумать", @"tothink"],
	  @[@"опять", @"again"],
	  @[@"белый", @"white"],
	  @[@"деньги", @"money"],
	  @[@"значить", @"tomean,signify"],
	  @[@"про", @"about,for"],
	  @[@"лишь", @"only,assoonas"],
	  @[@"минута", @"minute,moment"],
	  @[@"жена", @"wife"],
	  @[@"посмотреть", @"totakealook,watch,inspect"],
	  @[@"правда", @"truth"],
	  @[@"главный", @"main,chief"],
	  @[@"страна", @"country"],
	  @[@"свет", @"light;world"],
	  ...
	  @[@"лежать", @"tolie,besituated"],
	  @[@"именно", @"namely,just"],
	  @[@"окно", @"window,windowsill"],
	  @[@"никакой", @"no,none"],
	  @[@"найти", @"tofind,discover,consider"],
	  @[@"писать", @"towrite"],
	  @[@"комната", @"aroom"],
	  @[@"Москва", @"Moscow"],
	  @[@"часть", @"part,share,department"],
	  @[@"вообще", @"ingeneral,altogether,onthewhole"],
	  @[@"книга", @"abook"],
	  @[@"маленький", @"small,little"],
	  @[@"улица", @"street;masterrussian,dotcom"],
	  @[@"решить", @"todecide,solve"],
	  ...
	  @[@"утро", @"morning"],
	  @[@"некоторый", @"some"],
	  @[@"считать", @"tocount,consider"],
	  @[@"сколько", @"howmuch,howmany"],
	  @[@"помнить", @"toremember"],
	  @[@"вечер", @"evening"],
	  @[@"пол", @"floor;sex"],
	  @[@"таки", @"afterall"],
	  @[@"получить", @"toreceive,get,obtain"],
	  @[@"народ", @"people,nation"],
	  @[@"плечо", @"shoulder,upperarm"],
	  @[@"хоть", @"even,ifyouwant,though"],
	  @[@"сегодня", @"today"],
	  @[@"бог", @"god"],
	  @[@"вместе", @"together"],
	  ...
	  @[@"тело", @"body"],
	  @[@"молодой", @"young(see#);bridegroom(asa)"],
	  @[@"стена", @"wall"],
	  @[@"красный", @"red"],
	  @[@"читать", @"toread"],
	  @[@"право", @"right"],
	  ...
	  @[@"девушка", @"girl,miss(see#)"],
	  @[@"образ", @"shape,form,image"],
	  @[@"ко", @"to,towards,by(see#)"],
	  @[@"забыть", @"toforget"],
	  @[@"вокруг", @"around"],
	  @[@"письмо", @"letter"],
	  @[@"власть", @"power"],
	  @[@"чёрный", @"black(see#)"],
	  @[@"пройти", @"topass,goby,beover(see#)"],
	  @[@"появиться", @"toappear,showup(see#)"],
	  @[@"воздух", @"air"],
	  @[@"разный", @"different"],
	  @[@"выходить", @"togoout;nurse(see#)"],
	  @[@"просить", @"toask"],
	  @[@"брат", @"brother"],
	  @[@"собственный", @"one'sown;masterrussian,dotcom"],
	  ...
	  @[@"солдат", @"soldier"],
	  @[@"откуда", @"where…from"],
	  @[@"чтоб", @"that,inorderthat,(See#)"],
	  @[@"называть", @"tocall,name,(See#)"],
	  @[@"третий", @"third"],
	  @[@"хозяин", @"master,boss,host"],
	  @[@"вроде", @"like,notunlike"],
	  @[@"уходить", @"toleave,goaway"],
	  @[@"подойти", @"toapproach,comeup(See#)"],
	  ...
	  @[@"рассказать", @"totell,narrate(See#)"],
	  @[@"великий", @"great"],
	  @[@"действительно", @"indeed,really"],
	  @[@"слишком", @"too,toomuch"],
	  @[@"тяжёлый", @"heavy"],
	  @[@"спать", @"tosleep"],
	  @[@"оставить", @"toleave,abandon"],
	  @[@"войти", @"toenter,comein"],
	  @[@"длинный", @"long"],
	  @[@"чувство", @"feeling"],
	  @[@"молчать", @"tokeepsilence"],
	  @[@"рассказывать", @"totell,narrate,(See#)"],
	  @[@"отвечать", @"toanswer,reply,(See#)"],
	  @[@"становиться", @"tostand;tobecome"],
	  @[@"остановиться", @"tostop"],
	  ...
	  @[@"личный", @"personal"],
	  @[@"труд", @"labour,work"],
	  @[@"верить", @"tobelieve;masterrussian,dotcom"],
	  @[@"группа", @"group"],
	  @[@"немного", @"alittle"],
	  ...
	  @[@"смочь", @"tobeable"],
	  @[@"против", @"against,opposite,contraryto"],
	  @[@"бежать", @"torun,hurry"],
	  @[@"двор", @"yard,court"],
	  @[@"форма", @"form,shape,uniform"],
	  @[@"простой", @"simple,easy,plain"],
	  @[@"приехать", @"toarrive,come"],
	  @[@"иной", @"different,other"],
	  @[@"кричать", @"tocry,shout(See#)"],
	  ...
	  @[@"угол", @"corner,angle"],
	  @[@"открыть", @"toopen"],
	  @[@"происходить", @"tohappen,occur,takeplace"],
	  ...
	  @[@"немец", @"German"],
	  @[@"наверное", @"probably,mostlikely(See#)"],
	  @[@"губа", @"lip"],
	  @[@"дядя", @"uncle"],
	  @[@"приходить", @"tocome,arrive(See#)"],
	  @[@"часто", @"often"],
	  @[@"домой", @"home"],
	  @[@"огонь", @"fire"],
	  @[@"писатель", @"writer"],
	  ...
	  @[@"камень", @"stone"],
	  @[@"гость", @"guest"],
	  @[@"показаться", @"toappear,comeinsight"],
	  @[@"ветер", @"wind"],
	  @[@"собираться", @"togathertogether,assemble;intend(See#)"],
	  @[@"попасть", @"tohit;tofindoneself"],
	  @[@"принять", @"totake,admit,accept(See#)"],
	  @[@"сначала", @"atfirst,fromthebeginning"],
	  @[@"либо", @"or"],
	  @[@"поехать", @"todepart,setoff"],
	  @[@"услышать", @"tohear"],
	  @[@"уметь", @"tobeable,know,can"],
	  @[@"случиться", @"tohappen"],
	  @[@"странный", @"strange"],
